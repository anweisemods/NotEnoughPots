...
public enum NotEnoughPotsBlockType implements IPottedBlockType {
  ...
  POTTED_PALE_OAK_LEAVES(Blocks.PALE_OAK_LEAVES),
  // 1.21.5+
  POTTED_CACTUS_FLOWER(Blocks.CACTUS_FLOWER),
  ...
  // 26.3+
  POTTED_RED_POPLAR_LEAVES(Blocks.RED_POPLAR_LEAVES),
  POTTED_ORANGE_POPLAR_LEAVES(Blocks.ORANGE_POPLAR_LEAVES),
  POTTED_YELLOW_POPLAR_LEAVES(Blocks.YELLOW_POPLAR_LEAVES),
  POTTED_RED_SHRUB(Blocks.RED_SHRUB),
  POTTED_SHELF_MUSHROOM(Blocks.SHELF_MUSHROOM),
  ;
